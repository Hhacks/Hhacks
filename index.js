...
bot.on("message", async message => {	
    ...
    if (command === "gen") {	
        if (message.channel.id !== "872185981925720135") return message.channel.send("This command can be runned only in the generate channel")
        ...
        if (generated.has(message.author.id)) {	
            ...
            let account = JSON.parse(data)	
                ...
                const embed = {	
                    ...
                    color: f7fe00,
                    timestamp: "2021-08-04T14:16:26.398Z",	
                    footer: {	
                        icon_url:	
                            "https://cdn.discordapp.com/attachments/865267677001154562/871994081952276530/13529293.jpg",
                        text: "Dev By ALoieE If u want free bot call </𝔸𝕃𝕠𝕚𝕖𝔼#9999"
                    },	
                    thumbnail: {	
                        url:	
                            "https://cdn.discordapp.com/attachments/865267677001154562/871994081952276530/13529293.jpg"
...
bot.login("ODY4MTUxOTQ4NTY0NjYwMzE0.YPrfgg.Ylo7rEuwBJMbn7SWRspuRxfUWl0");
